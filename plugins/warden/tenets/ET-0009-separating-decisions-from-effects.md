---
id: ET-0009
title: Keep decisions pure; isolate effects in a thin shell
type: best-practice
tier: 1
applies-to: any
since: 0.2.0
triggers:
  ...
  - reviewing a diff where business logic is interleaved with `await db.query` / `requests.get` / `File.ReadAll*`
  - deciding where to place an algorithmic decision relative to the I/O it depends on
tags: [architecture, testing, purity, side-effects]
related: [ET-0004, ET-0010, ET-0011]
---
