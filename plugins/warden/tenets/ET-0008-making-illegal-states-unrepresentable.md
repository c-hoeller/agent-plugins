...
triggers:
  ...
  - reviewing a diff that adds a runtime check "if X is set then Y must also be set" on a struct/class/interface
  - deciding between a flat shape with multiple optionals and a discriminated union / sum type / sealed hierarchy
tags: [types, modeling, invariants, design]
related: [ET-0003, ET-0006, ET-0007]
---
