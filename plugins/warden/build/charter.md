...
- _"It's a small change"_ — diff size is not a tenet exception. Apply the Rule.

## Tier 1 — universal, always-relevant

- `ET-0001` — Never lower access modifiers for testing → skill `et-0001-keeping-test-helpers-private` · scoped
- `ET-0002` — Never silently swallow failures → skill `et-0002-surfacing-failures`
- `ET-0003` — Validate at trust boundaries, trust the core → skill `et-0003-validating-at-boundaries`
