---
name: et-0014-keeping-tests-independent
description: Keep tests independent and order-agnostic.
when_to_use: Use when writing a test that depends on data left behind by a previous test; using a module-level fixture or class-level mutable variable to share state between tests; reviewing a diff where reordering tests, randomising them, or running one in isolation would change the outcome; deciding where to put setup that touches database / filesystem / global state.
user-invocable: false
---
<!-- generated from tenets/ET-0014-keeping-tests-independent.md by `uv run poe build` — do not edit by hand. -->

# ET-0014 — Keep tests independent and order-agnostic
